...
#Using https://docs.python.org/3/library/socket.html as a reference for sockets and
#https://docs.python.org/3/library/struct.html for using the struct lib to pack parameters into byte data

'''
    percentage packet loss = (sent_packets - received_packets)/sent_packets * 100
    ...
    def rec_echo(self,start,icmpsocket,ID,timeout):
        while True: 
            ...
            try:
                ...
                icmp_header = recv_packet[20:28] #slicing the header out of the byte string
